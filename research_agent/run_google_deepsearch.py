...
Do not add an executive introduction, abstract, methodology section, conclusion, bibliography section, appendix, or any section outside the four required sections. Start directly with SECTION 1.
...
- the report contains only the four required sections
- there is no executive introduction, abstract, methodology section, conclusion, bibliography section, appendix, or extra section
